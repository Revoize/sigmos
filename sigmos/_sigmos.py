# The contents of this file have been copied over from
# https://github.com/microsoft/SIG-Challenge/tree/main/ICASSP2024/sigmos with minor
# modifications, and are distributed on the MIT License.
...
class SigMOS:
    ...
    def __init__(self, model_dir, model_version=Version.V1):
        if model_version not in list(Version):
            raise ValueError(
                f"Invalid model_version: {model_version}. "
                f"Must be one of {list(Version)}"
            )
